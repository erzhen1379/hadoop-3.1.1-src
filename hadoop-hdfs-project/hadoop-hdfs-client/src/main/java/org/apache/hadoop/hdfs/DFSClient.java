...
public class DFSClient implements java.io.Closeable, RemotePeerFactory,
  ...
  static LocatedBlocks callGetBlockLocations(ClientProtocol namenode,
    ...
    try {
      //todo 获得block信息
        ...
        LOG.debug("org.apache.hadoop.hdfs.DFSClient.callGetBlockLocations：从namenode 获取blockLocations："+blockLocations.toString());
  ...
  public DFSOutputStream create(String src, FsPermission permission,
    ...
    //todo 调用DFSOutputStream.newStreamForCreate()创建DFSOutputStream对象
    /**
     * 1.往文件目录树中添加文件
     * 2.添加租约
     * 3.启动dataStreamer
