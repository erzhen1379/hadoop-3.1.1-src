...
public class DatanodeInfo extends DatanodeID implements Node {
  ...
  public String toString() {
    return "DatanodeInfo{" +
            ...
            ", lastUpdateMonotonic=" + lastUpdateMonotonic +
            ", xceiverCount=" + xceiverCount +
            ", location='" + location + '\'' +
            ", softwareVersion='" + softwareVersion + '\'' +
            ", dependentHostNames=" + dependentHostNames +
            ", upgradeDomain='" + upgradeDomain + '\'' +
            ", numBlocks=" + numBlocks +
            ", adminState=" + adminState +
            ", maintenanceExpireTimeInMS=" + maintenanceExpireTimeInMS +
            ", lastBlockReportTime=" + lastBlockReportTime +
            ", lastBlockReportMonotonic=" + lastBlockReportMonotonic +
            ", level=" + level +
            ", parent=" + parent +
            '}';
  }
