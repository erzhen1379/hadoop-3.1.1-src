...
public interface DataTransferProtocol {
   ...
   */
  void readBlock(final ExtendedBlock blk,  //要读取的数据块
      final Token<BlockTokenIdentifier> blockToken,   //数据访问的令牌
      final String clientName,              //客户端的名称
      final long blockOffset,               //到读取数据在数据块中的位置
      final long length,                     //读取数据的长度
      final boolean sendChecksum,            //是否发送校验数据
      final CachingStrategy cachingStrategy) throws IOException;   //缓存的策略
